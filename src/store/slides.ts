...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    ...
    templates: [
      { name: '红色通用', id: 'template_1', cover: './data/template_1.jpg' },
      { name: '蓝色通用', id: 'template_2', cover: './data/template_2.jpg' },
      { name: '紫色通用', id: 'template_3', cover: './data/template_3.jpg' },
      { name: '莫兰迪配色', id: 'template_4', cover: './data/template_4.jpg' },
    ], // 模板
  }),
